...
@Component({
 ...
 imports: [CommonModule,MaterialModule],
  templateUrl: './delete-item-master.html',
  styleUrl: './delete-item-master.scss',
})
export class DeleteItemMaster {
 categoryId ='';
  
  constructor(@Inject(MAT_DIALOG_DATA) public data:any,private http:AllApiService,
  private router:Router,
    private snackBar: MatSnackBar,
   private dialogRef: MatDialogRef<DeleteItemMaster>) { }
 ...
 deleteRecord() {
  this.http.deleteById(ApiUrl.deleteItemMaster, this.categoryId).subscribe({
    next: (res: any) => {
      this.snackBar.open(
