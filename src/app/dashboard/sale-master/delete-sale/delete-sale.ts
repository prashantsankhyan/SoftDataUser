...
import { DeletePaymentReceipt } from '../../payment-receipt/delete-payment-receipt/delete-payment-receipt';
import { ApiUrl } from '../../../_core/apiUrl';

@Component({
  selector: 'app-delete-sale',
   imports: [CommonModule,MaterialModule],
  templateUrl: './delete-sale.html',
...
id ='';
 ...
 deleteRecord() {
  this.http.deleteById(ApiUrl.deleteSaleInvoice,this.id).subscribe({
    next: (res: any) => {
      this.snackBar.open(
