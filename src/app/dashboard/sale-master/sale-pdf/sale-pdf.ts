...
@Component({
  ...
  templateUrl: './sale-pdf.html',
  styleUrl: './sale-pdf.scss',
})
export class SalePdf {
...
showPack2 = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SalePdf>,
  ...
  ngOnInit(): void {
     ...
     this.data;
      ...
      this.saleInvoiceId = Number(this.data?.saleInvoiceId) || 0;
   
    // this.saleInvoiceId = this.route.snapshot.paramMap.get('saleInvoiceId');
    console.log('Invoice ID:', this.saleInvoiceId);
...
//  getAllData() {
//   this.api
//     .getAllDataId(ApiUrl.getPdfForSale, this.saleInvoiceId)
//     .subscribe((res: any) => {
...
applySaleScreenConfig() {
  this.showBarcode = !!this.screenConfig?.barcodeSale;
  this.showHsn = !!this.screenConfig?.hsnsale;
  this.showMRate = !!this.screenConfig?.mRateSale;
  this.showDiscPer = !!this.screenConfig?.discPercentSale;
  this.showDiscAmt = !!this.screenConfig?.discountSale;
  this.showRemarks = !!this.screenConfig?.remarksSale;
  this.showArt = !!this.screenConfig?.artSale;
  this.showSize = !!this.screenConfig?.sizeSale;
  this.showColor = !!this.screenConfig?.colorSale;
  this.showPack1 = !!this.screenConfig?.pack1Sale;
  this.showPack2 = !!this.screenConfig?.pack2Sale;
}
