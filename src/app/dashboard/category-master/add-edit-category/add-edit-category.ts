...
onKeyDown(event: KeyboardEvent) {
  ...
  private cdr: ChangeDetectorRef,public dialogRef: MatDialogRef<AddEditCategory>){}
...
updateData(): void {
  ...
  this.http.getAllDataId(ApiUrl.editCategory,this.categoryId)
    .subscribe({
      next: (res: any) => {
...
onSubmit() {
  ...
  this.http.addEditData(ApiUrl.addEditCategory, this.addEditForm.value)
    .subscribe({
      next: (res: any) => {
