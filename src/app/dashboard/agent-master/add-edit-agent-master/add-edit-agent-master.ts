...
@Component({
  selector: 'app-add-edit-agent-master',
 imports: [CommonModule,MaterialModule,RouterModule,ReactiveFormsModule,FormsModule],
  templateUrl: './add-edit-agent-master.html',
  styleUrl: './add-edit-agent-master.scss',
   providers: [TitleCasePipe]

})
export class AddEditAgentMaster {
...
onKeyDown(event: KeyboardEvent) {
 ...
 isSaving = false;
  ...
  private cdr: ChangeDetectorRef,public dialogRef: MatDialogRef<AddEditAgentMaster>){}
...
updateData(): void {
  ...
  this.http.getAllDataId(ApiUrl.editAgent,this.unitId)
    .subscribe({
      next: (res: any) => {
...
onSubmit() {
  ...
  this.http.addEditData(ApiUrl.AddEditAgent, this.addEditForm.value)
    .subscribe({
      next: (res: any) => {
